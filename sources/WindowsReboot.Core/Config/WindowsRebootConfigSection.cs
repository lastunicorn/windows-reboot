...
namespace DustInTheWind.WindowsReboot.Core.Config
{
    ...
    public class WindowsRebootConfigSection : ConfigurationSection
    {
        ...
        public ActionTimeConfigElement ActionTime
        {
            get
            {
                return (ActionTimeConfigElement)this["actionTime"] ?? new ActionTimeConfigElement();
            }
        }
        ...
        public ActionTypeConfigElement ActionType
        {
            get
            {
                return (ActionTypeConfigElement)this["actionType"] ?? new ActionTypeConfigElement();
            }
        }
        ...
        public ForceClosingProgramsConfigElement ForceClosingPrograms
        {
            get
            {
                return (ForceClosingProgramsConfigElement)this["forceClosingPrograms"] ?? new ForceClosingProgramsConfigElement();
            }
        }
        ...
        public StartTimerAtApplicationStartConfigElement StartTimerAtApplicationStart
        {
            get
            {
                return (StartTimerAtApplicationStartConfigElement)this["startTimerAtApplicationStart"] ?? new StartTimerAtApplicationStartConfigElement();
            }
        }
        ...
        public MinimizeToTrayConfigElement MinimizeToTray
        {
            get
            {
                return (MinimizeToTrayConfigElement)this["minimizeToTray"] ?? new MinimizeToTrayConfigElement();
            }
        }
        ...
        public CloseToTrayConfigElement CloseToTray
        {
            get
            {
                return (CloseToTrayConfigElement)this["closeToTray"] ?? new CloseToTrayConfigElement();
            }
        }
    }
}
